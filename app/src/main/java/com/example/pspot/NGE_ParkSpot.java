...
public class NGE_ParkSpot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nge_park_spot);
...
// Find the parking spot ImageView elements
        ...
        DocumentReference parkingSpotRef = db.collection("parkingSpots").document("NGE");

        // Add a listener to the document to listen for changes
        parkingSpotRef.addSnapshotListener(this, (documentSnapshot, e) -> {
            if (e != null) {
                // Handle errors here
                Toast.makeText(NGE_ParkSpot.this, "Error fetching updates", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void updateSpotUI(ImageView spotImageView, String spotValue) {
        ...
        if (isSpotAvailable) {
            ...
            if (spotImageView.getId() == R.id.A2 || spotImageView.getId() == R.id.B2 ||
                    ...
                    spotImageView.getId() == R.id.I2 || spotImageView.getId() == R.id.J2 ||
                    spotImageView.getId() == R.id.K2 || spotImageView.getId() == R.id.L2 ||
                    spotImageView.getId() == R.id.M2 || spotImageView.getId() == R.id.N2 ||
                    spotImageView.getId() == R.id.O2 || spotImageView.getId() == R.id.P2 ||
                    spotImageView.getId() == R.id.Q2 || spotImageView.getId() == R.id.R2) {
    ...
    private void toggleAvailableSpot(ImageView imageView, boolean isSelected) {
        ...
        DocumentReference spotRef = db.collection("parkingSpots").document("NGE");
        ...
        if (!isSelected && !isSpotAvailable(imageView)) {
            ...
            Toast.makeText(NGE_ParkSpot.this, "This parking spot is not available.", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private boolean isSpotAvailable(ImageView imageView) {
        ...
        if (viewId == R.id.A1 || viewId == R.id.B1 || viewId == R.id.C1 ||
            ...
            return imageView.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.availablecarspot).getConstantState());
                ...
                viewId == R.id.G2 || viewId == R.id.H2 || viewId == R.id.I2 ||
                viewId == R.id.J2 || viewId == R.id.K2 || viewId == R.id.L2 ||
                viewId == R.id.M2 || viewId == R.id.N2 || viewId == R.id.O2 ||
                viewId == R.id.P2 || viewId == R.id.Q2 || viewId == R.id.R2
        ) {
    ...
    public void onProfileButtonClick(View view) {
        Intent intent = new Intent(NGE_ParkSpot.this, Profile.class);
    ...
    public void navigateToHome(View view) {
        Intent intent = new Intent(NGE_ParkSpot.this, Home.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }
    ...
    public void navigateToVehicleTimer1(View view) {
        ...
        Intent intent = new Intent(NGE_ParkSpot.this, Car_Vehicle_Limit.class);
